...
public class DateSpecificationsTest {
	...
	public void isValidDay() {
		...
		Specification<String> isFebruarySpecification = new IsFebruary("/").and(new IsValidDay("/", 29));
		Specification<String> isValidDaySpecification = is31daysMonthSpecification.or(is30daysMonthSpecification).or(isFebruarySpecification);
		assertTrue(isValidDaySpecification.isSatisfiedBy("29/02"));
	}
}
